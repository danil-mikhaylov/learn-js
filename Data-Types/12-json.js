...
console.log(
  JSON.stringify(meetUp, ["title", "participants", "name", "occupiedBy"])
);
...
console.log(
  numbersInt.reduce((accumulator, currentValue) => accumulator + currentValue)
); // 15
...
console.log(
  numbersInt.filter(currentValue => currentValue > 3 && currentValue < 5)
);
