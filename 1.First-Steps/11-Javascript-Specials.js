...
console.log( "Посетитель: " + userName ); // Алиса
console.log( "Чай: " + isTeaWanted ); // true
...
switch (age) {
  case 18:
    console.log("Так не сработает"); // результатом prompt является строка, а не число
  ...
  default:
    console.log("Любое значение, неравное значению выше");
}
