...
//  */
//
// let dictionary = Object.create(null, { // Создаёам объект, [[Prototype]] -- null
...
Rabbit.prototype.sayHi = function() {
  // Сдесь единственным полем конструктора будет sayHi(...)
...
rabbit.sayHi(); // Только у него есть имя
Rabbit.prototype.sayHi(); // Ссылается на { sayHi: [Function (anonymous)] }
// Сдесь единственным полем конструктора будет sayHi(...)
Object.getPrototypeOf(rabbit).sayHi();
rabbit.__proto__.sayHi(); // Ссылается на { sayHi: [Function (anonymous)] }
